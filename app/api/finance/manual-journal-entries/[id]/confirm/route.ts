...
import { confirmManualJournalEntry } from "@/lib/finance/manual-journal-entry/manual-journal-entry-workflow"
...
export async function POST(req: NextRequest, context: Context) {
  try {
    ...
    await confirmManualJournalEntry({
      entryId: id,
      legalEntityCode,
    ...
    return manualJournalEntryErrorResponse(err, "POST manual-journal-entries/[id]/confirm")
  }
}
