...
export async function POST(req: NextRequest, context: Context) {
  try {
    ...
    const result = await rebuildEndDocument({ documentId: id, staffId })
    ...
    return endErrorResponse(err, "POST stock-document/end/[id]/rebuild error")
  }
}
