...
import { canAccessMasterDatabase, canAccessProductReference } from "@/lib/permissions/master"
...
export default async function MasterDatabasePage() {
  ...
  if (!canAccessMasterDatabase(session.role) && !canAccessProductReference(session.role)) {
