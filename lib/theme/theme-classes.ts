...
export const themeMuted = "text-muted-foreground"

export const themeInput =
  "mt-1 w-full rounded border border-border bg-card px-3 py-2 text-foreground"

export const themeBtnPrimary =
  "rounded bg-[var(--btn-primary-bg)] px-4 py-2 text-sm text-[var(--btn-primary-fg)] hover:bg-[var(--btn-primary-hover)] disabled:cursor-not-allowed disabled:bg-[var(--btn-disabled-bg)] disabled:text-[var(--btn-disabled-fg)]"

export const themeBtnSecondary =
  "rounded border border-[var(--btn-secondary-border)] bg-[var(--btn-secondary-bg)] px-3 py-1.5 text-sm font-medium text-[var(--btn-secondary-fg)] hover:bg-[var(--btn-secondary-hover)]"

export const themeLinkMuted =
  "text-muted-foreground underline hover:text-foreground disabled:cursor-not-allowed disabled:text-[var(--btn-disabled-fg)]"
